...
class Store(models.Model):
    ...
    cover = models.ImageField(upload_to="static/images/store",default="static/images/store/default.png", verbose_name="店铺名称")
    intro = models.TextField(verbose_name="店铺描述")
    openTime = models.DateTimeField(auto_now_add=True, verbose_name="开店时间")
    status = models.IntegerField(default=0, verbose_name="店铺状态") # 0 正常营业 1 暂停营业 2 永久删除
